...
(module+ test
  ...
  (check-equal? (L5 earth-sun)
                (posn 74799550825.28027 -129557400406.15201))
  (check-equal? (centimeters->meters 1000)
                10)
  (check-equal? (meters->centimeters 100)
                10000)
  (check-equal? (meters->kilometers 1000)
                1)
  (check-equal? (kilometers->meters 2)
                2000)
  (check-equal? (seconds->minutes 120)
                2)
  (check-equal? (minutes->seconds 3)
                180)
  (check-equal? (seconds->hours 3600)
                1)
  (check-equal? (hours->seconds 2)
                7200)
  (check-equal? (days->seconds 2)
                172800)
